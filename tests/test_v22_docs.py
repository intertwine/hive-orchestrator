...
def test_control_plane_docs_and_harness_guides_exist():
    """Reference docs should cover compare, IA, flows, harnesses, archived migration, and examples."""
    ...
    migration = (REPO_ROOT / "docs" / "archive" / "MIGRATING_TO_V2_2.md").read_text(
        encoding="utf-8"
    )
    ...
    assert 'description="Agent Hive control-plane CLI"' in parser
