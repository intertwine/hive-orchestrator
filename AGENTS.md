...
> This document provides comprehensive context for AI assistants (Codex, GPT-4, Gemini, etc.) working on the Agent Hive project.
...
1. **Agent A (Codex)**: Claims work by setting `owner: "Codex-3.5-sonnet"`
...
- Update this AGENTS.md for development changes
