...
def run_paths(run_directory: Path) -> dict[str, Path]:
    ...
    return {
        ...
        "steering_path": run_directory / "steering.ndjson",
        "driver_metadata_path": driver_dir / "driver-metadata.json",
        "driver_handles_path": driver_dir / "handles.json",
        "approval_channel_path": driver_dir / "approval-channel.ndjson",
...
def artifact_payload(metadata: dict) -> dict[str, object]:
    ...
    return {
        ...
        "trajectory": metadata.get("trajectory_path"),
        "steering": metadata.get("steering_path"),
        ...
        "approval_channel": metadata.get("approval_channel_path"),
