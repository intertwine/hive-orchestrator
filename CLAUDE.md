...
- Run validation appropriate to the changed surface: focused tests for narrow changes, `make check` for broad Python/runtime changes or required release/merge gates, and affected links/examples or documentation tests for documentation-only changes. Run `make console-check` for console changes. Preserve required CI and governed-run evaluation gates.
