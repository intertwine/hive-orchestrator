...
def sanitize_issue_body(body: str) -> str:
    ...
    This prevents injection attacks through issue content that might
    be parsed by Claude Code or other automated tools.
    ...
    # Sanitize using the standard function
    sanitized = sanitize_untrusted_content(sanitized, MAX_ISSUE_BODY_LENGTH)
