...
Agent Hive enables coordination between multiple AI agents (Codex, Grok, Gemini, etc.) using shared memory and optional real-time coordination. This skill covers patterns for effective multi-agent collaboration.
...
owner: "Codex-sonnet-4"  # Your agent identifier
```
...
|----------|-------------------|
| Anthropic Codex | `Codex-sonnet-4`, `Codex-opus-4` |
...
curl -X POST http://localhost:8080/claim \
  ...
  -d '{"project_id": "my-project", "agent_name": "Codex-sonnet-4", "ttl_seconds": 3600}'
```
...
- **2025-01-15 16:00 - grok-beta**: Completed API integration.
  @Codex-sonnet-4 - the auth module needs your review before merge.

- **2025-01-15 15:00 - Codex-sonnet-4**: Starting auth implementation.
