...
.Codex/skills/article-images/scripts/generate-images.sh

# Generate with OpenAI gpt-image-1.5
.Codex/skills/article-images/scripts/generate-images.sh --provider openai

# Generate specific article
.Codex/skills/article-images/scripts/generate-images.sh --glob "articles/prompts/01-*.md"

# Generate in parallel (4 concurrent images)
.Codex/skills/article-images/scripts/generate-images.sh --parallel 4

# Preview without generating (dry run)
.Codex/skills/article-images/scripts/generate-images.sh --dry-run

# Force regenerate all images
.Codex/skills/article-images/scripts/generate-images.sh --force
```
