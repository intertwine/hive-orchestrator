# Image Prompts: Getting Started - Your First Agent Hive Project

*These prompts are designed for Google Gemini Imagen 3 / Nano Banana Pro model. Generate 5-7 images for the article.*
...
## Image 6: Adding Dependencies

**Prompt:**
Create an image showing the establishment of project dependencies as a construction or planning scenario. Two project buildings are being built: "CONFIG-SYSTEM" is partially complete with active construction. "API-SERVER" is in blueprint phase, waiting. A visible "blocked_by" beam connects them, showing that API-SERVER cannot start until CONFIG-SYSTEM finishes. A robot project manager reviews the dependency diagram on a tablet, nodding approvingly at the orderly sequence. When CONFIG-SYSTEM shows a "COMPLETED" badge, the blocking beam transforms into a green "READY" light for API-SERVER. Construction planning illustration style, clear cause-and-effect relationship, satisfying unlock moment.

**Caption:** *Adding dependencies: declare that API-SERVER is blocked by CONFIG-SYSTEM. When CONFIG-SYSTEM completes, API-SERVER unlocks and becomes ready.*
...
**Style consistency:** Welcoming, approachable tutorial aesthetic. The imagery should feel like a friendly guide, not intimidating documentation. Combine technical precision with warm, inviting illustration.

**Aspect ratios:**
- Hero image (1): 16:9 landscape for aspirational opener
- Structure overview (2): 4:3 or 16:9 for architectural clarity
- Dashboard mockup (3): 16:9 landscape for screen aspect
- Creation activity (4): 4:3 or square for focused workspace
- Workflow diagram (5): Square 1:1 or 4:3 for cycle clarity
- Dependencies (6): 16:9 landscape for relationship illustration
- Reference poster (7): Portrait 3:4 or 2:3 for poster format

**Color palette:** Warm, welcoming colors. Use honey-gold Agent Hive branding accents throughout.

**Quality modifiers:** high-quality, detailed illustration, welcoming and approachable, clean modern aesthetic, tutorial-friendly
