...
The Hive MCP server exposes Agent Hive functionality as MCP tools, enabling AI agents like Codex to programmatically manage projects through standardized tool interfaces.
...
Add the Hive MCP server to your Codex configuration:

**For Codex Desktop (`~/.config/Codex/claude_desktop_config.json`):**
...
4. claim_project("my-proj", "Codex-sonnet-4")
5. [Do the work]
6. add_note("my-proj", "Codex-sonnet-4", "Completed task X")
...
2. coordinator_claim("my-proj", "Codex-sonnet-4", 3600)
3. claim_project("my-proj", "Codex-sonnet-4")  # Also update AGENCY.md
4. [Do the work]
