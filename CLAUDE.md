...
This repository no longer treats the old v1 Cortex runtime as the center of the system. If you are operating here, use the commands and files below.
...
- Do not add new product logic to `src/cortex.py`.
